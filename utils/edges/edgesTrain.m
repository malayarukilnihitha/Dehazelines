...
%{
    +++ path in standealone mode is not the same.It's why i gave a absolut path
...
% for standealone packaging 
forDeployementForestFn = [pwd,'/models/forest/modelBsds'];
load([forDeployementForestFn '.mat']); return;
